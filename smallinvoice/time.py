...
class TimeClient(object):
    ...
    def details(self, client_id):
        ...
        return self.client.request_with_method(time_details % (client_id,))[
            "item"]
    ...
    def delete(self, time_id):
        return self.client.request_with_method(delete_time % (time_id,),
                                               request_method=REQUEST_METHOD.POST)

    def update(self, time_id, time):
        return self.client.request_with_method(update_time % (time_id,),
                                               data=time)