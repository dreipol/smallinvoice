...
class CostunitClient(object):
    ...
    def details(self, client_id):
        ...
        return self.client.request_with_method(costunit_details % (client_id,))[
            "item"]
    ...
    def delete(self, costunit_id):
        return self.client.request_with_method(delete_costunit % (costunit_id,),
                                               request_method=REQUEST_METHOD.POST)

    def update(self, costunit_id, costunit):
        return self.client.request_with_method(update_costunit % (costunit_id,),
                                               data=costunit)