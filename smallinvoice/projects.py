...
class ProjectClient(object):
    ...
    def details(self, client_id):
        ...
        return self.client.request_with_method(project_details % (client_id,))[
            "item"]
    ...
    def delete(self, project_id):
        return self.client.request_with_method(delete_project % (project_id,),
                                               request_method=REQUEST_METHOD.POST)

    def update(self, project_id, project):
        return self.client.request_with_method(update_project % (project_id,),
                                               data=project)