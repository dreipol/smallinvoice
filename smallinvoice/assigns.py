...
class AssignClient(object):
    ...
    def details(self, client_id):
        ...
        return self.client.request_with_method(assign_details % (client_id,))[
            "item"]
    ...
    def delete(self, assign_id):
        return self.client.request_with_method(delete_assign % (assign_id,),
                                               request_method=REQUEST_METHOD.POST)

    def update(self, assign_id, assign):
        return self.client.request_with_method(update_assign % (assign_id,),
                                               data=assign)